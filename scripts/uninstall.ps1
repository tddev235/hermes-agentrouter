...
foreach($relative in @('agent\copilot_acp_client.py','agent\chat_completion_helpers.py','hermes_cli\models.py','hermes_cli\model_switch.py','hermes_cli\auth.py','hermes_cli\providers.py')){
